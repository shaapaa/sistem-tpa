-- Hubungkan akun wali dengan santri aktif melalui pencocokan identitas exact.
-- Tidak membuka akses SELECT santri maupun INSERT wali_santri untuk role SANTRI.
...
begin
  ...
  into current_role, current_is_active
