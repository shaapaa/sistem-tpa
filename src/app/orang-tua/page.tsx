  ...
  return (
    <div className="space-y-6">
      ...
      <section><SectionHeader title="Ringkasan utama" description={`Kondisi ${activeSantri.nama} pada ${periodLabel(period).toLowerCase()}.`} /><div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <Link href="/orang-tua/presensi" className="rounded-xl border border-emerald-200 bg-emerald-50/80 p-4 shadow-sm transition-all hover:-translate-y-0.5 hover:bg-emerald-100/80 hover:shadow-md"><CalendarCheck className="h-4 w-4 text-emerald-700" /><p className="mt-3 text-2xl font-semibold text-emerald-950">{attendanceRate}%</p><p className="text-sm font-medium text-emerald-900">Kehadiran</p><p className="mt-1 text-xs text-emerald-800/75">{hadir} dari {totalPres} pertemuan</p></Link>
        <Link href="/orang-tua/perkembangan" className="rounded-xl border border-amber-200 bg-amber-50/80 p-4 shadow-sm transition-all hover:-translate-y-0.5 hover:bg-amber-100/80 hover:shadow-md"><BookOpen className="h-4 w-4 text-amber-700" /><p className="mt-3 truncate text-sm font-semibold text-amber-950">{bacaanSummary}</p><p className="mt-1 text-sm font-medium text-amber-900">Bacaan</p><p className="mt-1 text-xs text-amber-800/75">{bacaanStatus}</p></Link>
        <Link href="/orang-tua/perkembangan" className="rounded-xl border border-violet-200 bg-violet-50/80 p-4 shadow-sm transition-all hover:-translate-y-0.5 hover:bg-violet-100/80 hover:shadow-md"><BookHeart className="h-4 w-4 text-violet-700" /><p className="mt-3 text-2xl font-semibold text-violet-950">{suratLulus}</p><p className="text-sm font-medium text-violet-900">Surat tuntas</p><p className="mt-1 text-xs text-violet-800/75">dari {TARGET_SURAT} target surat</p></Link>
        <Link href="/orang-tua/perkembangan" className="rounded-xl border border-sky-200 bg-sky-50/80 p-4 shadow-sm transition-all hover:-translate-y-0.5 hover:bg-sky-100/80 hover:shadow-md"><Moon className="h-4 w-4 text-sky-700" /><p className="mt-3 text-2xl font-semibold text-sky-950">{salatLancar}/{salatStatus.length}</p><p className="text-sm font-medium text-sky-900">Niat salat lancar</p><p className="mt-1 text-xs text-sky-800/75">{salatBimbingan ? `${salatBimbingan} perlu bimbingan` : "Tidak ada yang perlu dibimbing"}</p></Link>
      </div></section>
